/**
 * SQLite database access layer for the Slovenian Cybersecurity (SI-CERT) MCP server.
 *
 * Schema:
 *   - guidance    — SI-CERT cybersecurity guidelines and technical recommendations
 *   - advisories  — SI-CERT security advisories and incident alerts
 *   - frameworks  — SI-CERT framework series (NIS2 guidance, national cybersecurity guidelines)
 *
