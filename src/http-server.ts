      ...
      switch (name) {
        ...
        case "si_cyber_about": {
          return textContent({
            ...
            version: pkgVersion,
            description:
              "SI-CERT (Slovenian Computer Emergency Response Team) MCP server. Provides access to BSI technical guidelines, IT-Grundschutz building blocks, BSI Standards, and security advisories.",
